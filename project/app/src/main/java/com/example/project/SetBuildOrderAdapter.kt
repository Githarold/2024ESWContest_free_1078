...
class SetBuildOrderAdapter(private var ingredientList: ArrayList<Ingredient>) :
    RecyclerView.Adapter<SetBuildOrderAdapter.IngredientViewHolder>(), ItemMoveCallback {
